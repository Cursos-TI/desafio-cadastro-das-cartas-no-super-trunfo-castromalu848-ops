...
int main() {
   ...
   printf( "Digite o número da PIB 2: \n");
    ...
    printf("\n  ======Dados da carta 1===== \n"" Nome da cidade: %s \n estado: %s \n codigo: %s \n numero de pontos turisticos: %d \n populacao: %d \n PIB: %.2f \n Area: %.2f \n densidade: %.2f \n PIB_capita: %.2f", nome1, estado1, codigo1, numero_de_pontos_turisticos1, populacao1, PIB1, area1, densidade1, PIB_capita1);                     
    printf("\n\n =====Dados da carta 2===== \n"" Nome da cidade: %s \n estado: %s \n codigo: %s \n numero de pontos turisticos: %d \n populacao: %d \n PIB: %.2f \n Area: %.2f \n densidade: %.2f \n PIB_capita: %.2f", nome2, estado2, codigo2, numero_de_pontos_turisticos2, populacao2, PIB2, area2, densidade2, PIB_capita2);                   
